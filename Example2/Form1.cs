...
namespace Example2
{
    public partial class Form1 : Form
    {
        ...
        {
            ContactUpdateForm contactDetailForm = new ContactUpdateForm();
...
*/
        ...
        {
            bindingSource1.DataSource = bll.SortContacts();
        }
...
/*            curPage = Math.Max(0, Math.Min(bll.GetContactsInPage(curPage, searchingName).Count, curPage + 5));
        ...
        {
            ContactUpdateForm contactDetailForm = new ContactUpdateForm();
            MessageBox.Show("Name: " + dataGridView1.SelectedRows[0].Cells[1].Value.ToString() + "\n" +
                            "Phone: " + dataGridView1.SelectedRows[0].Cells[2].Value.ToString() + "\n" +
                            "Address: " + dataGridView1.SelectedRows[0].Cells[3].Value.ToString()); 
/*            contactDetailForm.phoneTxtBx.Text = dataGridView1.SelectedRows[0].Cells[2].Value.ToString();
            contactDetailForm.addressTxtBx.Text = dataGridView1.SelectedRows[0].Cells[3].Value.ToString();
*/        }
